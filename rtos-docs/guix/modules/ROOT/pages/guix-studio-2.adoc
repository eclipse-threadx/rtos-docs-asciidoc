...
+
image::guix-studio/clone-repo.png[Choose to clone the repo, point to an already-cloned repo, or skip.]
+
...
image::guix-studio/image_10.png[Screenshot of the GUIX Studio UI.]
