...
image::guix-studio/image38.jpg[Screenshot of the GUIX Studio Resource View.]
...
image::guix-studio/resource_view_color_section.png[Screenshot of the Colors section of the Resource View]
...
image::guix-studio/edit_color.png[Screenshot of the Edit Color dialog.]
...
image::guix-studio/resource_view_add_new_color.jpg[Add New Color button]

Use the resulting color dialog to add a new color resource, as shown below in _*Figure 11*:_

image::guix-studio/new_color.png[Screenshot of the New Color in the Edit Color dialog.]
...
image::guix-studio/edit_palette.png[Screenshot of the Edit Palette dialog.]
...
image::guix-studio/resource_view_font_section.png[Screenshot of the Fonts section in the Resource View.]
...
image::guix-studio/edit_system_font.png[Screenshot of the modification dialog when SYSTEM is double-clicked.]

*Figure 13*

To add a new font resource, from the *_Fonts_* section of the *_Resource View_* select the following button:

image::guix-studio/resource_view_add_new_font.jpg[Add New Font button]

This will invoke the `Font Edit` dialog to add a new font resource, as shown below in *_Figure 14_*:

image::guix-studio/add_new_font.png[Screenshot of the modification dialog to add a new font resource.]
...
image::guix-studio/pixelmap_view.png[Screenshot of the Pixel-maps section in the Resource View.]
...
image::guix-studio/edit_pixelmap.png[Screenshot of the Edit Pixel-maps dialog.]
...
image::guix-studio/resource_view_add_new_pixelmap.jpg[Add New Pixel-map button.]
...
image::guix-studio/batch_pixelmap_edit.jpg[Screenshot of the Edit Multi Pixel-maps dialog.]
...
image::guix-studio/string_res_view.png[Screenshot of the expanded Strings group.]
...
image::guix-studio/config_languages.png[Screenshot of the Language Configuration dialog.]
...
image::guix-studio/string_table_editor.jpg[Screenshot of the String table Editor.]
...
image::guix-studio/string_export.jpg[Screenshot of the XLIFF/CSV Export Control dialog.]
