...
image::guix/user-guide/no-frame-buffer.png[No frame buffer, graphics data held in external GRAM]
...
image::guix/user-guide/one-local-frame-buffer.png[One local frame buffer]
...
image::guix/user-guide/local-frame-buffer-external-gram.png[Local frame buffer + external GRAM]
...
image::guix/user-guide/ping-pong-frame-buffers.png[Ping-pong frame buffers]
...
image::guix/user-guide/ping-pong-buffers-canvas-composting.png[Ping-pong buffers with canvas compositing]
...
image::guix/user-guide/canvas-compositing-external-gram.png[Canvas compositing with external GRAM]
...
image::guix/user-guide/configure-languages.png[Configure languages]
...
image::guix/user-guide/memory-area-example.png[Memory layout]
...
**gx_<widget_type>_font_set** API provided for each text-related widget type. The entire font table can be re-assigned by calling the **gx_display_font_table_set** API function.
