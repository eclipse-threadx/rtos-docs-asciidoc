...
image::user-guide/screen_shot_10.png[Screenshot of the main display window of the TraceX system analysis tool.]
...
image::user-guide/screen_shot_11.png[Screenshot of the TraceX title bar.]
...
image::user-guide/screen_shot_12.png[Screenshot of the TraceX tool bar.]
...
image::user-guide/screen_shot_30.png[Screenshot of the Sequential View and Time View tabs.]
...
image::user-guide/screen_shot_31.png[Screenshot of the Time View tab.]
...
image::user-guide/screen_shot_32.png[Screenshot of the System Summary Line in the Sequential View tab.]
...
image::user-guide/screen_shot_33.png[Screenshot of the system contexts on the left-hand side of the display.]
...
image::user-guide/screen_shot_34.png[Screenshot of the information for thread 0.]
...
image::user-guide/screen_shot_35.png[Screenshot of the context being moved to the top of the context list.]
...
image::user-guide/screen_shot_36.png[Screenshot of the status of each thread via a colored line on the thread's context.]
...
image::user-guide/screen_shot_37.png[Screenshot of the mouse-over of event 143 in a sample trace file]
...
image::user-guide/screen_shot_38.png[Screenshot of the detailed event information when an event is double clicked.]
...
image::user-guide/screen_shot_39.png[Screenshot of the event search.]

*FIGURE 17*

image::user-guide/screen_shot_40.png[Screenshot of the search dialog.]
...
image::user-guide/screen_shot_41.png[Screenshot of a sample file zoomed out so that 100% of the trace file is shown.]
...
image::user-guide/screen_shot_42.png[Screenshot of the delta number of ticks between the events.]
...
image::user-guide/screen_shot_43.png[Screenshot of the priority inversion in a trace file.]
