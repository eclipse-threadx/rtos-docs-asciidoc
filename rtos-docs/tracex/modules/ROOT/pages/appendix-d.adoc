...
image::user-guide/image642.jpg[Screenshot of the Memory View in the BenchX tools.]
...
image::user-guide/image643.jpg[Screenshot of the the BenchX tools save dialog.]
...
image::user-guide/image0_311.jpg[Screenshot of the Memory Save option in the IAR tools.]
...
image::user-guide/image648.jpg[Screenshot of the IAR tools Memory Save dialog.]
...
image::user-guide/image0_316.jpg[Screenshot of the Memory selected on the View menu.]
...
image::user-guide/image650.png[Screenshot of the Memory View with the Display Format option selected.]

image::user-guide/image651.jpg[Screenshot of the Go To dialog.]
...
image::user-guide/image0_312.jpg[Screenshot of the Memory View with the Go To option selected.]

image::user-guide/image653.png[Screenshot of an example showing the event_buffer being displayed.]

*Step 4* This highlights the contents of the first location of the trace buffer, which is always the string BTXT....

image::user-guide/image0_313.jpg[Screenshot of the first location of the trace buffer.]

*Step 5* Now, right-click again to bring up the options menu, and select *Export Table*.

image::user-guide/image0_314.jpg[Screenshot of the Memory View with the Export Table option selected.]
...
image::user-guide/image656.jpg[Screenshot of the Export As dialog.]
...
image::user-guide/image657.jpg[Screenshot of the Memory Window.]

*Step 2* Place cursor within memory window and right click.

image::user-guide/image0_315.jpg[Screenshot of the Memory Window with the Save option selected.]
...
image::user-guide/image659.jpg[Screenshot of the Save Memory As dialog.]
