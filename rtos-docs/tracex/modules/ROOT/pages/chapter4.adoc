...
image::user-guide/execution_profile.png[Screenshot of the execution profile associated with the sample ThreadX demonstration trace.]
...
image::user-guide/popular_services.png[Screenshot of the popular services in the sample ThreadX demonstration trace.]
...
image::user-guide/popular_services_thread3.png[Screenshot of the analysis for a TraceX popular services.]
...
image::user-guide/thread_stack_usage.png[Screenshot of the TraceX Thread Stack Usage.]
...
image::user-guide/performance_statistics.png[Screenshot of the TraceX performance statistics.]
...
image::user-guide/filex_statistics.png[Screenshot of the FileX Statistics.]
...
image::user-guide/netx_statistics.png[Screenshot of the NetX Statistics.]
...
image::user-guide/trace_file_info.png[Screenshot of the TraceX File Information.]
...
image::user-guide/raw_trace_dump.png[Screenshot of the raw trace dump.]
