...
+
image::user-guide/filex-media-logical-sector-view.png[FileX Media Logical Sector View]
+
...
+
image::user-guide/10ms-increment-fields.png[10ms Increment Fields]

* *UTC Offset Field*
+
image::user-guide/utc-offset-field.png[UTC Offset Field]
...
image::user-guide/system-information.png[File with Contiguous Clusters vs. File Requiring FAT Link]
...
image::user-guide/fat-16-file-example.png[FileX FAT-16 File Example]
