...
image::user-guide/log-structure-layout.png[Log Structure Layout]
...
image::user-guide/fat-log-entry.png[FAT Log Entry]
...
image::user-guide/directory-log-entry.png[Directory Log Entry]
