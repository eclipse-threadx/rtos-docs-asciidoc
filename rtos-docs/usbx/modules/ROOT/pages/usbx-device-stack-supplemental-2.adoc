...
image::usbx-device-stack-supplemental/dfu-application-flow.png[DFU application flow]
...
image::usbx-device-stack-supplemental/zadig.png[Running Zadig for the first time]
...
image::usbx-device-stack-supplemental/pima-transactions.png[PIMA transactions]
