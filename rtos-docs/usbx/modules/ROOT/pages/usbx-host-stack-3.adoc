...
image::usbx-host-stack/usbx-host-stack.png[USBX Host Stack]
...
image::usbx-host-stack/usb-device-complex.png[Complex USB device]
...
image::usbx-host-stack/usbx-device-descriptor-framework.png[USBX Device Descriptor Framework in Memory]
