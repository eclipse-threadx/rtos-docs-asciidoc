...
* xref:usbx-device-stack-supplemental-1.adoc[*Chapter 1*] contains an introduction to USBX
...
* xref:usbx-device-stack-supplemental-6.adoc[*Chapter 6*] USBX device controller driver (DCD) Porting Considerations
* xref:usbx-device-stack-supplemental-7.adoc[*Chapter 7*] USBX Device Class Implementation Considerations
