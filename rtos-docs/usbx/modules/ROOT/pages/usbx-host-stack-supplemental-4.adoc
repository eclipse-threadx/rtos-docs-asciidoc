...
image::usbx-host-stack-supplemental/dps-client-server.png[Diagram of the commands/responses between the D P S client and the D P S server when a print job occurs.]
