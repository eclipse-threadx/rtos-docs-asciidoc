...
- xref:home:ROOT:lts.adoc[Product Support Policy]
...
[quote, Chris Rommel, Executive Vice President, VDC Research]
...
image::cru-logo-certification.png[CRU UL certification]
...
image::eal-logo-certification.png[EAL certification]
...
The Information Security evaluation lab used for Eclipse ThreadX Crypto libraries was atsec and the certification authority is link:https://csrc.nist.gov/projects/cryptographic-module-validation-program/Certificate/3394[The National Institute of Standards and Technology (NIST)].
