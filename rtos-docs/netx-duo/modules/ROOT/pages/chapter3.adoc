...
Where an "Allowed From" section lists Initialization, it means from *_tx_application_define_* onward, and not earlier. Initialization in ThreadX names the whole span between processor reset and the thread scheduling loop, but the kernel's internal data structures are set up by *_tx_kernel_enter_*, which calls *_tx_application_define_* once that work is done. NetX Duo creates ThreadX objects on the application's behalf -- *_nx_ip_create_*, for instance, creates a thread, a timer, a mutex and an event flags group -- so a NetX Duo service called before *_tx_kernel_enter_* either faults or has its work silently undone. See "Calling ThreadX Services During Initialization" in xref:threadx:ROOT:chapter3.adoc[Chapter 3 of the ThreadX User Guide].
...
image::user-guide/image12.jpg[Protocol Layering]
...
image::user-guide/image13.png[UDP Data Encapsulation]
...
image::user-guide/image14.jpg[Packet Header and Packet Pool Layout]
...
image::user-guide/ipv4-address-structure.PNG[Diagram of the IPv4 Address Structure.]
...
image::user-guide/ipv4-header-format.png[IPv4 Header Format]
...
image::user-guide/arp-packet-format.PNG[Diagram of the  ARP Packet Format.]
...
image::user-guide/icmpv4-ping-message.png[ICMPv4 Ping Message]
...
image::user-guide/image17.jpg[Diagram of a IGMP report message.]
...
image::user-guide/image18.png[Diagram of the IPv6 header format.]
...
image::user-guide/image19.png[Diagram of a basic ICMPv6 header.]
...
image::user-guide/image20.jpg[Diagram of an example Neighbor Solicitation header.]
...
image::user-guide/image21.png[Diagram of the UDP header format.]
...
image::user-guide/image22.png[Diagram of the TCP header format.]
...
image::user-guide/image24.png[Diagram of the states of the TCP state machine.]
...
image::user-guide/tsn-framework.png[Diagram of TSN Framework]
